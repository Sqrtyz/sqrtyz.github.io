...
![cod-54](/assets/img/blog_post/co/cod-54.png)
...
![cod-55](/assets/img/blog_post/co/cod-55.png)

#### 2. I-Type (ONLY ld)

![cod-58](/assets/img/blog_post/co/cod-58.png)
...
![cod-57](/assets/img/blog_post/co/cod-57.png)

#### 4. SB-Type (ONLY beq)

![cod-56](/assets/img/blog_post/co/cod-56.png)

+ 这里 ALU 执行的是 sub 运算，然后根据 `zero` 判断是否相等。如果 `zero` 为 1（beq 条件满足）且 `branch` 为 1（本条指令为 beq），那么就开跳。

#### 5. UJ-Type (ONLY jal)

![cod-59](/assets/img/blog_post/co/cod-59.png)
...
![cod-60](/assets/img/blog_post/co/cod-60.png)
