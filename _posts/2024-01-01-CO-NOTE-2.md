...
+ RISC vs. CISC
    ...
    ![cod-31](/assets/img/blog_post/co/cod-31.png)

### Basics: Instructions and Registers

+ Instruction Formats

    ![cod-32](/assets/img/blog_post/co/cod-32.png)
...
+ Register Operands
    ...
    ![cod-33](/assets/img/blog_post/co/cod-33.png)
...
+ Logical Arithmetic
    ...
    ![cod-39](/assets/img/blog_post/co/cod-39.png)

    ![cod-40](/assets/img/blog_post/co/cod-40.png)
...
+ 汇编码 $\to$ 机器码
    ...
    ![cod-34](/assets/img/blog_post/co/cod-34.png)

    可以看到，汇编码向机器码的转换已经很好理解了。更具体一点，它的规则如下：

    ![cod-35](/assets/img/blog_post/co/cod-35.png)
    ...
    ![cod-36](/assets/img/blog_post/co/cod-36.png)
    ...
    + I-Format Instructions
        ...
        ![cod-37](/assets/img/blog_post/co/cod-37.png)
    
    + S-Format Instructions

        主要包含 store instructions。

        ![cod-38](/assets/img/blog_post/co/cod-38.png)
...
+ 比较
    ...
    ![cod-41](/assets/img/blog_post/co/cod-41.png)
...
+ 使用 Jump address table 来指导跳转
    ...
    ![cod-42](/assets/img/blog_post/co/cod-42.png)
...
+ 指令的存储
    ...
    ![cod-43](/assets/img/blog_post/co/cod-43.png)
...
+ 堆栈
    ...
    ![cod-44](/assets/img/blog_post/co/cod-44.png)
    ...
    ![cod-45](/assets/img/blog_post/co/cod-45.png)
...
+ 32-Bit Immediate Addressing (U-Type)
    ...
    ![cod-46](/assets/img/blog_post/co/cod-46.png)
...
+ Branch Addressing (SB-Type)
    ...
    ![cod-47](/assets/img/blog_post/co/cod-47.png)
...
+ Jump Addressing (UJ-Type)
    ...
    ![cod-48](/assets/img/blog_post/co/cod-48.png)
...
+ An Example: C $\to$ Assembly $\to$ Machine
    ...
    ![cod-49](/assets/img/blog_post/co/cod-49.png)
...
2. Translating and starting a program (程序的编写和执行步骤)
    ...
    ![cod-50](/assets/img/blog_post/co/cod-50.png)
    ...
    + 关于 obj 文件
        ...
        ![cod-51](/assets/img/blog_post/co/cod-51.png)

        将其 Link 之后，生成 Executable 文件如下：

        ![cod-52](/assets/img/blog_post/co/cod-52.png)

    + 关于 Dynamic Linking & Lazy Linkage

        ![cod-53](/assets/img/blog_post/co/cod-53.png)
